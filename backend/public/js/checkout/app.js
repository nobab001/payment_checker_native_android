...
import { buildCheckoutModel, roundPayableTaka } from './model.js?v=10';
import { CheckoutRenderer } from './checkout-renderer.js?v=10';
import { HeaderComponent } from './components/header.js?v=10';
import { InteractionController } from './interaction/interaction-controller.js?v=10';
import { SkeletonController } from './interaction/skeleton-controller.js?v=10';
import { ErrorController } from './interaction/error-controller.js?v=10';
import { snapshotTab, SortController } from './interaction/sort-controller.js?v=10';
import { VerifyUxController } from './interaction/verify-ux-controller.js?v=10';
import { applyI18n, t } from './i18n.js?v=10';
