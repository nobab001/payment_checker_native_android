...
-- 12. Official Website Reviews Moderation
...
-- 13. Official Website Trusted Companies
...
* **সেন্সর সার্ভিস সুইচ**:
  - লিসেনিং সার্ভিস অন/অফ সুইচ। এটি চালু করার পূর্বে ৪টি সিকিউরিটি ভ্যালিডেশন চেক সম্পন্ন করা হয়:
    1. ইউজারের প্যাকেজ সক্রিয় আছে কিনা (`isPaid`)।
    2. অ্যাপের ভেতরে অন্তত যেকোনো একটি সিম স্লট সক্রিয় করা আছে কিনা (`sim1Enabled || sim2Enabled`)।
    3. অ্যান্ড্রয়েড অ্যাক্সেসিবিলিটি পারমিশন দেওয়া আছে কিনা।
    4. অ্যান্ড্রয়েড এসএমএস রিড/রিসিভ করার পারমিশন দেওয়া আছে কিনা।
    এই ৪টি চেক সফল হলে ব্যাকগ্রাউন্ড সার্ভিস চালু হবে। কোনো ফিজিক্যাল সিম কার্ড ডিটেকশন চেক এখানে করা হয় না, ফলে এমুলেটর বা সিম রিডিং বাধার ক্ষেত্রেও লোকাল কনফিগারেশনের সাহায্যে মনিটর চালু করা সম্ভব।
* **ব্যালেন্স ও টপ-আপ**:
...
### ✅ Session: 2026-06-28 — Dashboard Recent Transactions & Search Quick Date Filters
**কী করা হয়েছে:**
- **Dashboard Default Recent Transactions**: ড্যাশবোর্ড স্ক্রিনে ডিফল্টভাবে আজকের তারিখ ফিল্টার বন্ধ করে সাম্প্রতিক ২০টি ট্রানজেকশন প্রদর্শন করার ব্যবস্থা করা হয়েছে এবং এর হেডার "আজকের ট্রানজেকশন" থেকে পরিবর্তন করে "সাম্প্রতিক ট্রানজেকশন" করা হয়েছে।
- **Search Quick Date Filters**: সার্চ পেইজে সার্চ বক্স ও সাজেশন চিপসের মাঝখানে ৫টি দ্রুত তারিখ নির্বাচনের বাটন (২ দিন, ৭ দিন, ১৫ দিন, ২১ দিন, ৩০ দিন) যুক্ত করা হয়েছে যা ডাইনামিকভাবে ডেট রেঞ্জ ক্যালকুলেট করে ট্রানজেকশন ফিল্টার করে।
- **Pagination & Reset Handling**: কাস্টম ক্যালেন্ডার নির্বাচনের মাধ্যমে কুইক ফিল্টার বাটনগুলোর হাইলাইট রিলেট রিসেট করার লজিক এবং নো-ডেট ফিল্টারে পেজিনেশন ও ডেট ফিল্টারে আন-পেজিনেটেড ফ্লো ঠিকভাবে হ্যান্ডেল করা হয়েছে।
- **Verification & Kotlin Compilation**: অ্যান্ড্রয়েড ক্লায়েন্টের সম্পূর্ণ অ্যাপ্লিকেশন পুনরায় কম্পাইল এবং এপিকে বিল্ড করা হয়েছে (`.\gradlew.bat compileDebugKotlin` ও `.\build-apk.bat` passes) এবং গিটহাবে পুশ সম্পন্ন হয়েছে।
