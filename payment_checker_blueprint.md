...
- **Database Seed Lock**: সার্ভার প্রতিবার চালু হলে যাতে ডাটাবেজের প্ল্যান, এসএমএস টেমপ্লেট ও গেটওয়েসমূহ পুনরায় হার্ডকোডেড সিড না হয়, তার তার জন্য `global_config` টেবিলে `db_seeded` ফ্লাগ ব্যবহার করা হয়েছে। এটি ডাটাবেজ টেবিল একবার সিড হওয়ার পর পরবর্তীতে ওভাররাইট হওয়া সম্পূর্ণ প্রতিরোধ করে।
