...
class SmsMonitorService : Service() {
    ...
    companion object {
        ...
        /**
         * Optional status callback for FGS notification text.
         * Manifest [SmsReceiver] is the sole SMS ingest path — this is display-only.
         */
        @Volatile
        var paymentStatusListener: ((online.paychek.app.utils.SmsParser.ParsedPayment) -> Unit)? = null
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Manifest SmsReceiver is the sole SMS ingest path (no dynamic register — avoids double onReceive).
        // Optional status callback updates this FGS notification when a payment is queued.
        ...
        // Missed-SMS recovery while FGS starts (process may have been dead during broadcast).
